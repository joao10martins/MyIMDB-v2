...
public class TopRatedRecyclerAdapter extends RealmRecyclerViewAdapter<TopRatedRealm, TopRatedRecyclerAdapter.TopRatedViewHolder>  {
    ...
    public TopRatedRecyclerAdapter(OrderedRealmCollection<TopRatedRealm> data,
                                  Context context,
    ...
    class TopRatedViewHolder extends RecyclerView.ViewHolder {
        ...
        public TopRatedRealm data;

        final TopRatedRecyclerAdapter mAdapter;

        public TopRatedViewHolder(View movieView, TopRatedRecyclerAdapter adapter) {
            super(movieView);
    ...
    public TopRatedViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new TopRatedViewHolder(mMovieView, this);
    }

    @Override
    public void onBindViewHolder(@NonNull TopRatedViewHolder holder, int position) {

        final TopRatedRealm currentItem = getItem(position);
