...
public class PopularRecyclerAdapter extends RealmRecyclerViewAdapter<PopularRealm, PopularRecyclerAdapter.PopularViewHolder>  {
    ...
    public PopularRecyclerAdapter(OrderedRealmCollection<PopularRealm> data,
                                     Context context,
    ...
    class PopularViewHolder extends RecyclerView.ViewHolder {
        ...
        public PopularRealm data;

        final PopularRecyclerAdapter mAdapter;

        public PopularViewHolder(View movieView, PopularRecyclerAdapter adapter) {
            super(movieView);
    ...
    public PopularViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new PopularViewHolder(mMovieView, this);
    }

    @Override
    public void onBindViewHolder(@NonNull PopularViewHolder holder, int position) {

        final PopularRealm currentItem = getItem(position);
